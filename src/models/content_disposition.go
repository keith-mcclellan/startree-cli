...
// ContextValidate validates this content disposition based on context it is used
func (m *ContentDisposition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
