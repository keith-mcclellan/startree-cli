...
// ContextValidate validates this parameterized header based on context it is used
func (m *ParameterizedHeader) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
