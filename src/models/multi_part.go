...
// ContextValidate validate this multi part based on the context it is used
func (m *MultiPart) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MultiPart) contextValidateBodyParts(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MultiPart) contextValidateContentDisposition(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MultiPart) contextValidateMediaType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MultiPart) contextValidateParameterizedHeaders(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MultiPart) contextValidateParent(ctx context.Context, formats strfmt.Registry) error {
