...
func (o *PutParams) WithBody(body string) *PutParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put params
func (o *PutParams) SetBody(body string) {
	o.Body = body
}

// WithTableName adds the tableName to the put params
func (o *PutParams) WithTableName(tableName string) *PutParams {
	o.SetTableName(tableName)
	return o
}

// SetTableName adds the tableName to the put params
func (o *PutParams) SetTableName(tableName string) {
