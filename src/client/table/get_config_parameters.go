...
// WithTableName adds the tableName to the get config params
func (o *GetConfigParams) WithTableName(tableName string) *GetConfigParams {
	o.SetTableName(tableName)
	return o
}

// SetTableName adds the tableName to the get config params
func (o *GetConfigParams) SetTableName(tableName string) {
