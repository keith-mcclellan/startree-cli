...
UploadSegmentAsMultiPartParams contains all the parameters to send to the API endpoint
	...
	for the upload segment as multi part operation.
...
// WithDefaults hydrates default values in the upload segment as multi part params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UploadSegmentAsMultiPartParams) WithDefaults() *UploadSegmentAsMultiPartParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the upload segment as multi part params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UploadSegmentAsMultiPartParams) SetDefaults() {
	var (
...
// WithAllowRefresh adds the allowRefresh to the upload segment as multi part params
func (o *UploadSegmentAsMultiPartParams) WithAllowRefresh(allowRefresh *bool) *UploadSegmentAsMultiPartParams {
	o.SetAllowRefresh(allowRefresh)
	return o
}

// SetAllowRefresh adds the allowRefresh to the upload segment as multi part params
func (o *UploadSegmentAsMultiPartParams) SetAllowRefresh(allowRefresh *bool) {
...
// WithTableType adds the tableType to the upload segment as multi part params
func (o *UploadSegmentAsMultiPartParams) WithTableType(tableType *string) *UploadSegmentAsMultiPartParams {
	o.SetTableType(tableType)
	return o
}

// SetTableType adds the tableType to the upload segment as multi part params
func (o *UploadSegmentAsMultiPartParams) SetTableType(tableType *string) {
