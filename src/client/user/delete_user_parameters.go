...
// WithComponent adds the component to the delete user params
func (o *DeleteUserParams) WithComponent(component *string) *DeleteUserParams {
	o.SetComponent(component)
	return o
}

// SetComponent adds the component to the delete user params
func (o *DeleteUserParams) SetComponent(component *string) {
