...
// WithSchemaName adds the schemaName to the get schema params
func (o *GetSchemaParams) WithSchemaName(schemaName string) *GetSchemaParams {
	o.SetSchemaName(schemaName)
	return o
}

// SetSchemaName adds the schemaName to the get schema params
func (o *GetSchemaParams) SetSchemaName(schemaName string) {
