...
// WithSchemaName adds the schemaName to the delete schema params
func (o *DeleteSchemaParams) WithSchemaName(schemaName string) *DeleteSchemaParams {
	o.SetSchemaName(schemaName)
	return o
}

// SetSchemaName adds the schemaName to the delete schema params
func (o *DeleteSchemaParams) SetSchemaName(schemaName string) {
