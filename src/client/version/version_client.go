...
type ClientService interface {
	GetVersionNumber(params *GetVersionNumberParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetVersionNumberOK, error)
...
*/
func (a *Client) GetVersionNumber(params *GetVersionNumberParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetVersionNumberOK, error) {
