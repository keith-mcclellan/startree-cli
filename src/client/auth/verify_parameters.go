...
// WithAccessType adds the accessType to the verify params
func (o *VerifyParams) WithAccessType(accessType *string) *VerifyParams {
	o.SetAccessType(accessType)
	return o
}

// SetAccessType adds the accessType to the verify params
func (o *VerifyParams) SetAccessType(accessType *string) {
	o.AccessType = accessType
}

// WithEndpointURL adds the endpointURL to the verify params
func (o *VerifyParams) WithEndpointURL(endpointURL *string) *VerifyParams {
	o.SetEndpointURL(endpointURL)
	return o
}

// SetEndpointURL adds the endpointUrl to the verify params
func (o *VerifyParams) SetEndpointURL(endpointURL *string) {
	o.EndpointURL = endpointURL
}

// WithTableName adds the tableName to the verify params
func (o *VerifyParams) WithTableName(tableName *string) *VerifyParams {
	o.SetTableName(tableName)
	return o
}

// SetTableName adds the tableName to the verify params
func (o *VerifyParams) SetTableName(tableName *string) {
...
func (o *VerifyParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.EndpointURL != nil {
		...
		// query param endpointUrl
		var qrEndpointURL string

		if o.EndpointURL != nil {
			qrEndpointURL = *o.EndpointURL
		}
		qEndpointURL := qrEndpointURL
		if qEndpointURL != "" {

			if err := r.SetQueryParam("endpointUrl", qEndpointURL); err != nil {
				return err
			}
		}
	}
