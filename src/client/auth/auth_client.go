...
type ClientService interface {
	...
	Verify(params *VerifyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*VerifyOK, error)

	SetTransport(transport runtime.ClientTransport)
}

/*
Info retrieves auth workflow info
*/
...
/*
Verify checks whether authentication is enabled
*/
func (a *Client) Verify(params *VerifyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*VerifyOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
